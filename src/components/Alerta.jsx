...
export default function Alerta({ alerta }) {
  ...
  return (
    <div className="fixed bottom-0 right-0 md:top-0">
      <div className="flex items-start px-8 py-8">
        <div className="sm:flex">
          ...
          >
                ...
                stroke-width="1.5"
                stroke="currentColor"
                className={`mx-auto w-5 h-[26px] ${alerta.error ? "text-red-100" : "text-blue-100"} `}
              >
                <path
              ...
              <div className={`ml-3 font-semibold ${alerta.error ? "text-red-100" : "text-blue-100"} flex-1`}>
              ...
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                className={`h-[26px] w-5 ml-2 ${alerta.error ? "text-red-100" : "text-blue-100"} `}
